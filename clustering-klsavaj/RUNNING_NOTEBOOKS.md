...
```python
!pip install numpy>=2.0 matplotlib>=3.8 scikit-learn>=1.5
```
...
python -m ipykernel install --user --name=ps4-clustering
```

Then select "ps4-clustering" as your kernel in VS Code.
