...
def load_required_packages():
    ...
    if not pyproject_path.exists():
        ...
        return ['numpy', 'matplotlib', 'pandas', 'scikit-learn', 'openpyxl', 'requests']
    ...
    try:
        ...
        return packages if packages else ['numpy', 'matplotlib', 'pandas', 'scikit-learn', 'openpyxl', 'requests']
...
# Map package distribution names to their importable module names
IMPORT_NAME_MAP = {
