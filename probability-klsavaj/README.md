[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/nitTcnUo)
# CS6140 Problem Set 2

**Please refer to Canvas for the assignment due date.**

## Overview

This problem set focuses on using visualization and statistical techniques to understand a dataset. You'll work with a mixture of log-normal distributions and uniform noise, applying methods such as:
- Visual diagnostics (histograms, KDE, Q-Q plots)
- Empirical moment calculations (mean, variance, skewness)
- Theoretical moment derivations for log-normal distributions
- Parameter estimation via method of moments and grid search
